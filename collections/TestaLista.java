...
public class TestaLista {
	...
	public static void main(String[] args) {
		...
		List<Carro> meusCarros = new ArrayList<Carro>();
		
		Carro carro1 = new Carro("Audi X1",2022,"prata","2.2");
		meusCarros.add(carro1); // inseri informação
		
		meusCarros.add(new Carro("Renegade",2018,"preto","2.0"));
		meusCarros.add(new Carro("Etios",2019,"vermelho","1.6"));
		...
		boolean resp = meusCarros.contains(new Carro("Etios",2019,"vermelho","1.6"));
